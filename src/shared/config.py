...
INCIDENT_SYNC_API_URL = os.environ.get("INCIDENT_SYNC_API_URL", "")
INCIDENT_SYNC_API_KEY = os.environ.get("INCIDENT_SYNC_API_KEY", "")
INCIDENT_SYNC_ACCEPT = os.environ.get("INCIDENT_SYNC_ACCEPT", "application/json")
INCIDENT_SYNC_TRANSACTION_ID_HEADER = os.environ.get(
